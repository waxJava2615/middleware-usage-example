package com.wax.infrastructure.tenant.helper;
...
import com.wax.infrastructure.core.reflect.ReflectUtils;
import com.wax.infrastructure.core.text.Convert;
import com.wax.infrastructure.core.utils.SpringUtils;
import com.wax.infrastructure.redis.utils.RedisUtils;
import com.wax.infrastructure.satoken.helper.LoginHelper;
...
public class TenantHelper {
    ...
    private static final String DYNAMIC_TENANT_KEY = CommonConstants.GLOBAL_REDIS_KEY + "dynamicTenant";
    ...
    public static void enableIgnore() {
        ...
        if (ObjectUtils.allNull(ignoreStrategy)) {
    ...
    public static void disableIgnore() {
        IgnoreStrategy ignoreStrategy = getIgnoreStrategy();
        if (ObjectUtils.allNotNull(ignoreStrategy)) {
